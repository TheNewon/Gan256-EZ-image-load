...
"""
"""
Created on Mon Sep 19 15:03:45 2019
...
Images = np.asarray([np.asarray(Image.open(file).resize((256, 256))) for file in glob(INPUT_DATA_DIR + '*')])
...
class Model_GAN(object):
    ...
    def evaluate(self):
        ...
        scipy.misc.toimage(im1, cmin=0.0, cmax=255.0).save('1.jpg')
        scipy.misc.toimage(im2[0]*255, cmin=0.0, cmax=255.0).save('2.jpg')
        scipy.misc.toimage(im2[1]*255, cmin=0.0, cmax=255.0).save('3.jpg')
